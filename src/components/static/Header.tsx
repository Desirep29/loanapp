...
import { Search, User, PenLine, Calendar, Lock, Menu, X, ChevronDown, ChevronUp } from "lucide-react";
...
export function Header() {
  ...
  const [isPersonalDropdownOpen, setIsPersonalDropdownOpen] = useState<boolean>(false);
    ...
    <header className="bg-white sticky top-0 z-50">
      ...
      <div className="bg-[#B8D430] text-[#006064] py-2 px-4">
        <div className="container mx-auto flex justify-end items-center gap-6 text-sm font-medium">
          ...
          <Link to="/about/careers" className="hover:underline hidden sm:block">
            Careers
          </Link>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-8">
            ...
            <Link to="/" className="flex items-center gap-3 flex-shrink-0">
              ...
              <div>
                <div className="text-2xl font-bold text-[#006064]">First International</div>
            ...
            <nav className="hidden lg:flex items-center gap-6 flex-1 justify-center">
              ...
              >
                <button 
                  className="text-gray-700 hover:text-[#006064] font-medium border-b-2 border-[#B8D430] flex items-center gap-1"
                >
                  About
                  <svg
                    className={`w-4 h-4 transition-transform ${
